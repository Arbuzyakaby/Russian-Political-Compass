...
(function(PC){
  ...
  var DICT = {
    ...
    "votes.lede":         ["Координаты на компасе выведены в том числе из того, как фракции голосуют, а не только из того, что партии пишут в программах. Здесь эти голосования собраны в одну таблицу: восемь законопроектов 2004–2022 годов, вокруг которых позиции расходились сильнее всего.",
                           "The compass coordinates are derived in part from how factions actually vote, not only from what parties write in their platforms. Here those votes are gathered into one table: eight bills from 2004 to 2022 on which positions diverged the most."],
    ...
    "ab.votes.p":         ["Программу можно написать какой угодно, голосование — уже поступок. Отдельная вкладка собирает восемь знаковых законопроектов от монетизации льгот 2004 года до признания ДНР и ЛНР в 2022-м и показывает, как по ним разошлись фракции.",
                           "A platform can say anything; a vote is an act. A separate tab collects eight landmark bills, from the 2004 monetisation of social benefits to the 2022 recognition of the DPR and LPR, and shows how the factions split on each."],
    ...
    "ft.data.l3":         ["<b>8</b> ключевых голосований", "<b>8</b> landmark votes"],
