...
(function(PC){
  ...
  var DICT = {
    ...
    "set.theme.provence": ["Прованс", "Provence"],
    ...
    "wel.up.l1":          ["3D-пролёт камеры над компасом при первом заходе.",
                           "A 3D camera fly-over of the compass on your first visit."],
    "wel.up.l2":          ["Новая тема «Прованс», а «Боровляны» стали тёмным хвойным лесом.",
                           "A new “Provence” theme, and “Borovlyany” is now a dark pine forest."],
    "wel.up.l3":          ["Объёмные переключатели и новые настройки: скорость анимаций, контраст, подчёркивание ссылок.",
                           "Tactile 3D toggles and new settings: animation speed, contrast, link underlines."],
    "wel.up.l4":          ["Раздел «О проекте» стал короче, а в нём появилось слово автора.",
                           "The About section is shorter and now has a note from the author."],
    "wel.up.l5":          ["Исправлены ошибки на телефоне, включая перерисовку диаграммы мандатов. И кое-что про число 22.",
                           "Mobile fixes, including the seat chart redrawing itself. And something about the number 22."],
    ...
    "foot.version.tip":   ["Версия 2.2: 3D-пролёт, тема «Прованс», новые настройки и переключатели",
                           "Version 2.2: 3D fly-over, the Provence theme, new settings and toggles"],
