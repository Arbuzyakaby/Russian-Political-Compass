...
(function(PC){
  ...
  var DICT = {
    ...
    "set.theme.borovlyany":["Боровляны", "Borovlyany"],
    ...
    "wel.up.l1":          ["В карточке партии можно сравнить её с любой другой по всем шести под-осям.",
                           "A party's card can now compare it with any other across all six sub-axes."],
    "wel.up.l2":          ["В песочнице коалиций появилось «связующее звено»: участник, чья позиция ближе всего сразу ко всем остальным.",
                           "The coalition sandbox now finds a “bridging member”: whoever sits closest to every other member at once."],
    "wel.up.l3":          ["Настройки разложены по шести постоянным разделам вместо разросшегося произвольного списка.",
                           "Settings are sorted into six fixed sections instead of a list that kept growing on its own."],
    "wel.up.l4":          ["Тема «Прованс» и объёмные переключатели убраны — решение сделать интерфейс спокойнее, а не добавить эффектов.",
                           "The “Provence” theme and the tactile 3D toggles are gone — a deliberate choice to make the interface calmer, not busier."],
    "wel.up.l5":          ["Расчёты компаса вынесены в отдельный слой и покрыты тестами отдельно от интерфейса.",
                           "The compass calculations now live in their own layer, tested separately from the interface."],
    ...
    "foot.version.tip":   ["Версия 2.3: расчётный слой, сравнение партий, связующее звено коалиции, настройки по шести разделам",
                           "Version 2.3: a shared calc layer, party comparison, the coalition's bridging member, settings sorted into six sections"],
