...
(function(PC){
  ...
  var DICT = {
    ...
    "wel.up.l1":          ["Приветствие начинается с выбора языка и больше не угадывает его по браузеру.",
                           "The welcome screen now starts by asking for your language instead of guessing it from the browser."],
    "wel.up.l2":          ["Короткое анимированное обучение: четыре сцены о том, как пользоваться компасом.",
                           "A short animated tour: four scenes on how to use the compass."],
    "wel.up.l3":          ["Новая тема «Боровляны» — мокрый лес после дождя.",
                           "A new theme, “Borovlyany” — a forest just after the rain."],
    "wel.up.l4":          ["Интерфейс стал спокойнее: сегментированные вкладки, круглые кнопки, мягкие тени.",
                           "A calmer interface: segmented tabs, rounded buttons, softer shadows."],
    "wel.up.l5":          ["Переработана шапка и исправлено несколько ошибок.",
                           "A reworked header and a handful of bug fixes."],
