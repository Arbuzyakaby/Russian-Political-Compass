...
(function(PC){
  ...
  function exportCSS(){
    return [
      ...
      /* ---- стекло поля (2.4.1) ---- */
      ".gs-plate-hi{stop-color:" + glass("#ffffff", ".20", ".92") + "}",
      ".gs-plate-mid{stop-color:" + glass("#ffffff", ".075", ".6") + "}",
      ".gs-plate-lo{stop-color:" + glass("#000000", ".13", ".07") + "}",
      ".gs-rim-hi{stop-color:" + glass("#ffffff", ".85", ".92") + "}",
      ".gs-rim-mid{stop-color:" + (light() ? "#000000;stop-opacity:.12;" : "#ffffff;stop-opacity:.30;") + "}",
      ".gs-rim-lo{stop-color:" + (light() ? "#000000;stop-opacity:.16;" : "#ffffff;stop-opacity:.10;") + "}",
      ".gs-sheen-a{stop-color:" + glass("#ffffff", ".28", ".85") + "}",
      ".gs-sheen-b{stop-color:" + glass("#ffffff", ".09", ".3") + "}",
      ".gs-sheen-c{stop-color:#ffffff;stop-opacity:0;}",
      ".lens-rim{fill:none;stroke:" + v("line-frame") + ";stroke-width:1;opacity:.55;}",
      ".frame{fill:none;stroke-width:2;}",
      ".frame-inner{fill:none;stroke:" + v("line-frame") + ";stroke-width:1;opacity:.4;}",
