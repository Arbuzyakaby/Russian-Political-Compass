...
(function(PC){
  ...
  Object.assign(PC.i18nDict, {
    ...
    "wel.up.l1":          ["Список ⇄ карточка партии и карточка ⇄ другая карточка теперь переворачиваются, как игральная карта.",
                           "Switching between the party list, a party's card, and another card now flips the panel like a playing card."],
    "wel.up.l2":          ["Настройки — окно по центру с рельсом из шести разделов вместо одной длинной прокрутки.",
                           "Settings are now a centred window with a six-section rail instead of one long scroll."],
    "wel.up.l3":          ["Тема «Боровляны» убрана: тем шесть вместо семи.",
                           "The “Borovlyany” theme is gone: six themes instead of seven."],
    "wel.up.l4":          ["Проверка контраста в настройках теперь проходит по каждой теме, а не по одной — заодно нашли и поправили едва заметный огрех в «Аляске».",
                           "The settings' contrast check now runs against every theme, not just one — which caught and fixed a barely visible slip in “Alaska”."],
    "wel.up.l5":          ["Код разложен по большему числу файлов, каждый — на своём месте: расчёт теста и коалиций, данные партий и голосований, словарь по разделам.",
                           "The code is split across more files, each with a clear job: quiz and coalition math, party and vote data, the dictionary by section."],
    ...
    "foot.version.tip":   ["Версия 2.3.1: переворот карточек, настройки окном с рельсом разделов, шесть тем, код по файлам",
                           "Version 2.3.1: card-flip panel transitions, a windowed settings rail, six themes, code split across more files"],
