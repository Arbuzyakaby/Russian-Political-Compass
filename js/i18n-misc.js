...
(function(PC){
  ...
  Object.assign(PC.i18nDict, {
    ...
    "wel.up.l1":          ["Компас: слоистый редизайн — поле теперь стоит на стеклянных подложках, а не на одной плоской панели.",
                           "The compass has a layered redesign: the field now rests on glass backdrops instead of a single flat panel."],
    "wel.up.l2":          ["На компасе впервые появился человек, а не партия: Владимир Путин, с отдельной, визуально особой карточкой.",
                           "For the first time the compass shows a person rather than a party: Vladimir Putin, with his own, visually distinct card."],
    "wel.up.l3":          ["Раздел «Приватность» (PVFP) расширен, а расшифровка сменилась на Privacy-first page.",
                           "The Privacy section (PVFP) has been expanded, and its expansion changed to Privacy-first page."],
    "wel.up.l4":          ["Замочек в разделе «Приватность» получил более живую анимацию открытия.",
                           "The lock icon in the Privacy section now has a livelier unlock animation."],
    "wel.up.l5":          ["На телефоне выбор партии на компасе больше не открывает следом системное меню iOS поверх карточки.",
                           "On the phone, picking a party on the compass no longer pops open iOS's own selection menu right after."],
    ...
    "foot.version.tip":   ["Версия 2.3.2: слоистый редизайн компаса, Владимир Путин на поле, расширенный раздел «Приватность» (PVFP), правка выбора партии на телефоне",
                           "Version 2.3.2: a layered redesign of the compass, Vladimir Putin added to the field, an expanded Privacy section (PVFP), a fix for picking a party on mobile"],
