...
(function(PC){
  ...
  Object.assign(PC.i18nDict, {
    ...
    "wel.up.l1":          ["Исправлена подпись партии, наезжавшая на печать Владимира Путина на компасе — заметнее всего это было в английской версии.",
                           "Fixed a party label overlapping Vladimir Putin's seal on the compass — most visible in the English version."],
    "wel.up.l2":          ["«Новые люди» — координата по вертикали пересчитана: фракция голосует по охранительным законам вместе с большинством.",
                           "New People — the vertical coordinate has been recalculated: the faction now votes for restrictive laws alongside the majority."],
    "wel.up.l3":          ["Приветственный экран: более живые анимации карточки, шагов и списка возможностей.",
                           "The welcome screen: livelier animations for the card, its steps and the list of features."],
    "wel.up.l4":          ["Раздел «Приватность» (PVFP) получил новую витрину: строка-протокол, иконки пунктов, светящаяся рамка.",
                           "The Privacy section (PVFP) got a new showcase: a protocol strip, point icons, a glowing frame."],
    "wel.up.l5":          ["Новая технология в разделе «Интерфейс»: Fluid-Grid Dynamic Responsive Interface (FGDRI).",
                           "A new technology in the Interface section: Fluid-Grid Dynamic Responsive Interface (FGDRI)."],
    ...
    "foot.version.tip":   ["Версия 2.3.3: исправлена подпись партии на печати Путина, новая координата «Новых людей», живее анимации приветствия, новая витрина PVFP и Fluid-Grid Dynamic Responsive Interface",
                           "Version 2.3.3: fixed a party label over Putin's seal, a new coordinate for New People, livelier welcome-screen animations, a new PVFP showcase, and the Fluid-Grid Dynamic Responsive Interface"],
