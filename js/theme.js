...
(function(PC){
  ...
  var THEMES = [
    ...
    { id:"borovlyany", key:"set.theme.borovlyany", bg:"linear-gradient(160deg,#12281b 0%,#06110b 100%)", dot:"#6fbf7f" },
    { id:"provence",  key:"set.theme.provence",  bg:"linear-gradient(160deg,#f6f0e6 0%,#e6dcef 100%)", dot:"#6f55a8" }
  ];
